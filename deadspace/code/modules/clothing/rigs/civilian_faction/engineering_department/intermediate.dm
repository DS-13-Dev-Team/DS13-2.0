/datum/mod_theme/deadspace/intermediate_engineer
	...
	default_skin = "intermediate_engineer"
	armor = list(BLUNT = 42, PUNCTURE = 30, SLASH = 37.5, LASER = 37.5, ENERGY = 37.5, BOMB = 42, BIO = 100, FIRE = 100, ACID = 40)
	...
	skins = list(
		...
		"intermediate_engineer_anodized" = list(
			HELMET_FLAGS = list(
				UNSEALED_LAYER = WOUND_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
				SEALED_CLOTHING = THICKMATERIAL|STOPSPRESSUREDAMAGE,
		...
		"intermediate_engineer_burnished" = list(
			HELMET_FLAGS = list(
				UNSEALED_LAYER = WOUND_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
				SEALED_CLOTHING = THICKMATERIAL|STOPSPRESSUREDAMAGE,
		...
		"intermediate_engineer_forged" = list(
			HELMET_FLAGS = list(
				UNSEALED_LAYER = WOUND_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
				SEALED_CLOTHING = THICKMATERIAL|STOPSPRESSUREDAMAGE,
