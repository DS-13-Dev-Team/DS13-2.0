...
/datum/action/cooldown/necro/regenerate/PreActivate(atom/target)
	if(!set_target(target))
		return FALSE
	. = ..()

/datum/action/cooldown/necro/regenerate/proc/set_target(atom/target)
	target_necro = owner
	return TRUE
...
/datum/action/cooldown/necro/regenerate/proc/start_stun()
...
/datum/action/cooldown/necro/regenerate/proc/finish_stun()
...
/datum/action/cooldown/necro/regenerate/proc/tick()
...
/datum/action/cooldown/necro/regenerate/proc/finish()
