/datum/action/cooldown/necro/swing/leaper
	...
	swing_time = 1.2 SECONDS
	move_time = 0.5 SECONDS
	angle = 40
	range = 1
	visual_type = /obj/effect/temp_visual/swing/leaper
	hitsound = 'sound/weapons/guillotine.ogg' //I really like the sound of this one
...
/datum/action/cooldown/necro/swing/leaper/windup()
	...
	sleep(0.6 SECONDS) //Should be exactly as long as the first animation
...
/obj/effect/temp_visual/swing/leaper
	...
	variable_icon = FALSE
	swing_sound = list(
		'deadspace/sound/effects/creatures/necromorph/leaper/leaper_tailswing_1.ogg',
		'deadspace/sound/effects/creatures/necromorph/leaper/leaper_tailswing_2.ogg',
		'deadspace/sound/effects/creatures/necromorph/leaper/leaper_tailswing_3.ogg',
		'deadspace/sound/effects/creatures/necromorph/leaper/leaper_tailswing_4.ogg',
		)
