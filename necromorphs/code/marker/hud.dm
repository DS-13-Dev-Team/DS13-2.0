...
/datum/hud/marker/New(mob/camera/marker_signal/owner)
	...
	psy_energy.add_filter("alpha_filter", 1, alpha_mask_filter(clamp(HUD_METER_PIXEL_WIDTH*(owner.psy_energy/owner.psy_energy_maximum), 0, owner.psy_energy_maximum), 0, icon('necromorphs/icons/hud/healthbar.dmi', "alpha_mask"), flags = MASK_INVERSE))
