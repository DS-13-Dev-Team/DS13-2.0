...
/datum/unit_test/screenshot_humanoids/Run()
	...
	*/
	...
	for (var/datum/species/species_type as anything in subtypesof(/datum/species) - /datum/species/moth - typesof(/datum/species/lizard) - typesof(/datum/species/necromorph))
