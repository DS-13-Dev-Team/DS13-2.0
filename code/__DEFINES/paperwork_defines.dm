...
#define EARTHGOV_FAX_MACHINE "Earth Government"

/// Global list of all admin fax machine destinations
GLOBAL_LIST_INIT(admin_fax_destinations, list(SYNDICATE_FAX_MACHINE, CENTCOM_FAX_MACHINE, EARTHGOV_FAX_MACHINE))
